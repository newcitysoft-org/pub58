...
public class SystemConfig {
    ...
    public static int REQUEST_MAX_TIMES = 10;

    public static List<String> REQUEST_EMPHASIS_DOMAINS = new ArrayList<>();
    public static List<String> REQUEST_DOMAINS = new ArrayList<>();

    /**
     * 默认每一个域名的任务数阈值
     */
    public static int DEFAULT_REQUEST_JOB_NUM = 50;
    /**
     * 每一个域名对应的任务数阈值
     */
    public static Map<String, Integer> domainJobNumThresholds = new HashMap<>();
